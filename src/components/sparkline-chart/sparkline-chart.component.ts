...
@Component({
  ...
  `,
  // styleUrls: [
  //   '@swimlane/ngx-charts/src/lib/common/base-chart.component.scss',
  // ],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SparklineChartComponent extends BaseChartComponent {
  ...
  yScale: any;
  xScale: any;
  colors: ColorHelper = new ColorHelper(this.scheme, this.schemeType, [], this.customColors);
  ...
  getScaleType(values: Array<any>): ScaleType {
    let date = true;
    let num = true;
